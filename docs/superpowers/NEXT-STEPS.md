...
| Stufe 2 — Checkbox pro Hint-Kategorie | 📝 [#622](https://github.com/flutter/dart-intellij-third-party/issues/622) + SDK-Issue [sdk#64101](https://github.com/dart-lang/sdk/issues/64101) angelegt (21.08., kreuzverlinkt); Plan: `plans/2026-08-21-inlay-hints-per-category-options.md` (Task 0 ✅). Warten auf Richtung der SDK-Maintainer (DanTup/bwilkerson), erst dann CL bauen |
